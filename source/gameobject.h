...
{
public:
    enum ObjectType {Ball, Wall, Gate, Pacman, Ghost, Blank, PowerBall, PowerBall02, PowerBall03, PowerBall04, PowerBall05, PowerBall06, PowerBall07};
